...
extern "C"
{
    ...
    UNITY_INTERFACE_EXPORT Context* ContextCreate(int uid, UnityEncoderType encoderType, UnityDecoderType decoderType)
    {
        ...
        ctx = ContextManager::GetInstance()->CreateContext(uid, encoderType, decoderType);
        return ctx;
    }
