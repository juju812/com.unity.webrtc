...
namespace webrtc
{
    ...
    */
    ...
    NvDecoder::NvDecoder(CUcontext cuContext, cudaVideoCodec eCodec, int maxWidth, int maxHeight) :
        m_cuContext(cuContext), m_eCodec(eCodec), m_nMaxWidth(maxWidth), m_nMaxHeight(maxHeight)
    {
